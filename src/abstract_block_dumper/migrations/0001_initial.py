    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['status', 'next_retry_at'], name='abstract_bl_status_c3786f_idx'), models.Index(fields=['block_number', 'executable_path'], name='abstract_bl_block_n_97b116_idx')],
                'constraints': [models.UniqueConstraint(fields=('block_number', 'executable_path', 'args_json'), name='unique_task_attempt')],
            },
        ),
    ]
